...
num_corr_tb<- shopping_trend %>% 
  ...
  dplyr::select(-Customer.ID, -Gender, -Item.Purchased, -Category, -Location,
                -Size, -Color, -Season, -Subscription.Status, -Shipping.Type, -Discount.Applied,
...
shopping_trend$Gender <- as.integer(factor(shopping_trend$Gender))
shopping_trend$Item.Purchased <- as.integer(factor(shopping_trend$Item.Purchased))
shopping_trend$Category <- as.integer(factor(shopping_trend$Category))
shopping_trend$Location <- as.integer(factor(shopping_trend$Location))
shopping_trend$Size <- as.integer(factor(shopping_trend$Size))
shopping_trend$Color <- as.integer(factor(shopping_trend$Color))
shopping_trend$Season <- as.integer(factor(shopping_trend$Season))
shopping_trend$Shipping.Type  <- as.integer(factor(shopping_trend$Shipping.Type ))
shopping_trend$Discount.Applied <- as.integer(factor(shopping_trend$Discount.Applied))
shopping_trend$Promo.Code.Used <- as.integer(factor(shopping_trend$Promo.Code.Used))
shopping_trend$Payment.Method <- as.integer(factor(shopping_trend$Payment.Method))
shopping_trend$Frequency.of.Purchases <- as.integer(factor(shopping_trend$Frequency.of.Purchases))
shopping_trend$Subscription.Status <- as.integer(factor(shopping_trend$Subscription.Status))
```
